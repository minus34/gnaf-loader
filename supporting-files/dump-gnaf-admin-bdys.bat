"C:\Program Files\PostgreSQL\11\bin\pg_dump" -Fc -d geo -n gnaf_201908 -p 5432 -U postgres > "C:\git\minus34\gnaf-201908.dmp"
"C:\Program Files\PostgreSQL\11\bin\pg_dump" -Fc -d geo -n admin_bdys_201908 -p 5432 -U postgres > "C:\git\minus34\admin-bdys-201908.dmp"
