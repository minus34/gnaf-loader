"C:\Program Files\PostgreSQL\10\bin\pg_dump" -Fc -d geo -n gnaf_201808 -p 5432 -U postgres > "C:\git\minus34\gnaf-201808.dmp"
"C:\Program Files\PostgreSQL\10\bin\pg_dump" -Fc -d geo -n admin_bdys_201808 -p 5432 -U postgres > "C:\git\minus34\admin-bdys-201808.dmp"
