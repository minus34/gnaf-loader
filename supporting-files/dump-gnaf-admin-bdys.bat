"C:\Program Files\PostgreSQL\10\bin\pg_dump" -Fc -d geo -n gnaf_201902 -p 5432 -U postgres > "C:\git\minus34\gnaf-201905.dmp"
"C:\Program Files\PostgreSQL\10\bin\pg_dump" -Fc -d geo -n admin_bdys_201902 -p 5432 -U postgres > "C:\git\minus34\admin-bdys-201905.dmp"
