"C:\Program Files\PostgreSQL\11\bin\pg_dump" -Fc -d geo -n gnaf_202011 -p 5432 -U postgres > "C:\git\minus34\gnaf-202011.dmp"
"C:\Program Files\PostgreSQL\11\bin\pg_dump" -Fc -d geo -n admin_bdys_202011 -p 5432 -U postgres > "C:\git\minus34\admin-bdys-202011.dmp"
