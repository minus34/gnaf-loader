...
python3 /Users/$(whoami)/git/minus34/gnaf-loader/load-gnaf.py --pgport=5432 --pgdb=geo --max-processes=6 --gnaf-tables-path="${GNAF_PATH}" --admin-bdys-path="${BDYS_PATH}" --srid=7844
...
docker build --squash --tag minus34/gnafloader-gda2020:latest --tag minus34/gnafloader-gda2020:202111 --build-arg BASE_URL="https://minus34.com/opendata/geoscape-202111-gda2020" .
docker push --all-tags minus34/gnafloader-gda2020
