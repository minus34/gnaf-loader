...
/Applications/Postgres.app/Contents/Versions/16/bin/pg_restore -Fc -d geo -p 5432 -U postgres ./gnaf-202605.dmp
rm ./gnaf-202605.dmp

curl --insecure https://minus34.com/opendata/geoscape-202605/admin-bdys-202605.dmp --output ./admin-bdys-202605.dmp
/Applications/Postgres.app/Contents/Versions/16/bin/pg_restore -Fc -d geo -p 5432 -U postgres ./admin-bdys-202605.dmp
