...
/Applications/Postgres.app/Contents/Versions/14/bin/pg_restore -Fc -d geo -p 5432 -U postgres ./gnaf-202211.dmp
rm ./gnaf-202211.dmp

curl --insecure https://minus34.com/opendata/geoscape-202211/admin-bdys-202211.dmp --output ./admin-bdys-202211.dmp
/Applications/Postgres.app/Contents/Versions/14/bin/pg_restore -Fc -d geo -p 5432 -U postgres ./admin-bdys-202211.dmp
