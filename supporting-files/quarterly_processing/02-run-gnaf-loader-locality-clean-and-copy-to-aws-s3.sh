...
AWS_PROFILE="minus34"
OUTPUT_FOLDER="/Users/$(whoami)/tmp/geoscape_202211"
GNAF_PATH="/Users/$(whoami)/Downloads/g-naf_nov22_allstates_gda94_psv_109"
BDYS_PATH="/Users/$(whoami)/Downloads/NOV22_AdminBounds_GDA94_SHP"
...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER} s3://minus34.com/opendata/geoscape-202211 --exclude "*" --include "*.zip" --acl public-read
...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER} s3://minus34.com/opendata/geoscape-202211 --exclude "*" --include "*.csv" --acl public-read
...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER} s3://minus34.com/opendata/geoscape-202211 --exclude "*" --include "*.dmp" --acl public-read
...
python ${SCRIPT_DIR}/../../spark/02_export_gnaf_and_admin_bdys_to_s3.py --admin-schema="admin_bdys_202211" --gnaf-schema="gnaf_202211" --output-path="${OUTPUT_FOLDER}/parquet"

aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER}/parquet s3://minus34.com/opendata/geoscape-202211/parquet --acl public-read
