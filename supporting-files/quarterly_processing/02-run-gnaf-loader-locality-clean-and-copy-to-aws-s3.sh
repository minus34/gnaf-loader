...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER} s3://minus34.com/opendata/geoscape-202411 --exclude "*" --include "*.zip" --acl public-read
...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER} s3://minus34.com/opendata/geoscape-202411 --exclude "*" --include "*.csv" --acl public-read
...
/Applications/Postgres.app/Contents/Versions/14/bin/pg_dump -Fc -d geo -n gnaf_202411 -p 5432 -U postgres -f "${OUTPUT_FOLDER}/gnaf-202411.dmp" --no-owner
echo "GNAF schema exported to dump file"
/Applications/Postgres.app/Contents/Versions/14/bin/pg_dump -Fc -d geo -n admin_bdys_202411 -p 5432 -U postgres -f "${OUTPUT_FOLDER}/admin-bdys-202411.dmp" --no-owner
...
python ${SCRIPT_DIR}/../../spark/xx_export_gnaf_and_admin_bdys_to_geoparquet.py --admin-schema="admin_bdys_202411" --gnaf-schema="gnaf_202411" --output-path="${OUTPUT_FOLDER}/geoparquet"

aws --profile=${AWS_PROFILE} s3 rm s3://minus34.com/opendata/geoscape-202411/geoparquet/ --recursive
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER}/geoparquet s3://minus34.com/opendata/geoscape-202411/geoparquet --acl public-read
