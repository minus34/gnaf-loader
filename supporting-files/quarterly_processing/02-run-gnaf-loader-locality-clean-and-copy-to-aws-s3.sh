...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER} s3://minus34.com/opendata/geoscape-202302 --exclude "*" --include "*.dmp" --acl public-read
...
python ${SCRIPT_DIR}/../../spark/02_export_gnaf_and_admin_bdys_to_s3.py --admin-schema="admin_bdys_202302" --gnaf-schema="gnaf_202302" --output-path="${OUTPUT_FOLDER}/parquet"

aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER}/parquet s3://minus34.com/opendata/geoscape-202302/parquet --acl public-read
