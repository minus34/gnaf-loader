...
GNAF_2020_PATH="/Users/$(whoami)/Downloads/g-naf_may23_allstates_gda2020_psv_1011"
BDYS_2020_PATH="/Users/$(whoami)/Downloads/may23_adminbounds_gda_2020_shp"
...
python3 /Users/$(whoami)/git/iag_geo/psma-admin-bdys/locality-clean.py --pgport=5432 --pgdb=geo --max-processes=6 --output-path=${OUTPUT_FOLDER_2020} --admin-schema admin_bdys_202305_gda2020

# upload locality bdy files to S3
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER_2020} s3://minus34.com/opendata/geoscape-202305-gda2020 --exclude "*" --include "*.zip" --acl public-read
...
/Applications/Postgres.app/Contents/Versions/14/bin/pg_dump -Fc -d geo -n gnaf_202305_gda2020 -p 5432 -U postgres -f "${OUTPUT_FOLDER_2020}/gnaf-202305.dmp" --no-owner
echo "GNAF schema exported to dump file"
/Applications/Postgres.app/Contents/Versions/14/bin/pg_dump -Fc -d geo -n admin_bdys_202305_gda2020 -p 5432 -U postgres -f "${OUTPUT_FOLDER_2020}/admin-bdys-202305.dmp" --no-owner
...
python ${SCRIPT_DIR}/../../spark/02_export_gnaf_and_admin_bdys_to_s3.py --admin-schema="admin_bdys_202305_gda2020" --gnaf-schema="gnaf_202305_gda2020" --output-path="${OUTPUT_FOLDER_2020}/parquet"

aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER_2020}/parquet s3://minus34.com/opendata/geoscape-202305-gda2020/parquet --acl public-read
