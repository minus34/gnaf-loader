...
AWS_PROFILE="minus34"
OUTPUT_FOLDER_2020="/Users/$(whoami)/tmp/geoscape_202211_gda2020"
GNAF_2020_PATH="/Users/$(whoami)/Downloads/g-naf_nov22_allstates_gda2020_psv_109"
BDYS_2020_PATH="/Users/$(whoami)/Downloads/NOV22_AdminBounds_GDA_2020_SHP"
...
python3 /Users/$(whoami)/git/iag_geo/concord/create_concordance_file.py --pgdb=geo --admin-schema="admin_bdys_202211_gda2020" --gnaf-schema="gnaf_202211_gda2020" --output-path=${OUTPUT_FOLDER_2020}
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER_2020} s3://minus34.com/opendata/geoscape-202211-gda2020 --exclude "*" --include "*.csv" --acl public-read

echo "---------------------------------------------------------------------------------------------------------------------"
echo "dump postgres schemas to a local folder"
echo "---------------------------------------------------------------------------------------------------------------------"

/Applications/Postgres.app/Contents/Versions/13/bin/pg_dump -Fc -d geo -n gnaf_202211_gda2020 -p 5432 -U postgres -f "${OUTPUT_FOLDER_2020}/gnaf-202211.dmp" --no-owner
echo "GNAF schema exported to dump file"
/Applications/Postgres.app/Contents/Versions/13/bin/pg_dump -Fc -d geo -n admin_bdys_202211_gda2020 -p 5432 -U postgres -f "${OUTPUT_FOLDER_2020}/admin-bdys-202211.dmp" --no-owner
...
aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER_2020} s3://minus34.com/opendata/geoscape-202211-gda2020 --exclude "*" --include "*.dmp" --acl public-read
...
python ${SCRIPT_DIR}/../../spark/02_export_gnaf_and_admin_bdys_to_s3.py --admin-schema="admin_bdys_202211_gda2020" --gnaf-schema="gnaf_202211_gda2020" --output-path="${OUTPUT_FOLDER_2020}/parquet"

aws --profile=${AWS_PROFILE} s3 sync ${OUTPUT_FOLDER_2020}/parquet s3://minus34.com/opendata/geoscape-202211-gda2020/parquet --acl public-read
