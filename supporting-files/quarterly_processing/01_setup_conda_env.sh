...
conda install -y -c conda-forge gdal libgdal-arrow-parquet pygeos dask-geopandas geoplot openpyxl psycopg geoalchemy2 rasterio jupyter boto3 aiohttp requests
conda activate ${ENV_NAME}
