...
/Applications/Postgres.app/Contents/Versions/10/bin/pg_dump -Fc -d geo -n gnaf_201805 -p 5432 -U postgres -f ${output_folder}/gnaf-201805.dmp
echo "GNAF schema exported to dump file"

/Applications/Postgres.app/Contents/Versions/10/bin/pg_dump -Fc -d geo -n admin_bdys_201805 -p 5432 -U postgres -f ${output_folder}/admin-bdys-201805.dmp
