...
DROP TABLE IF EXISTS admin_bdys.aus_comm_electoral_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_gccsa_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_iare_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_iloc_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_ireg_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_lga_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_locality_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_mb_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_remoteness_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_sa1_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_sa2_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_sa3_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_sa4_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_sos_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_sosr_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_state_electoral_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_state_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_sua_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_ucl_2011_boundaries CASCADE;
DROP TABLE IF EXISTS admin_bdys.aus_ward_boundaries CASCADE;
