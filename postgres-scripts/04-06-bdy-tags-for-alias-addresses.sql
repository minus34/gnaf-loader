INSERT INTO gnaf.address_alias_admin_boundaries (gnaf_pid, locality_pid, old_locality_pid, locality_name, postcode, state, ce_pid, ce_name, lga_pid, lga_name, ward_pid, ward_name, se_lower_pid, se_lower_name, se_upper_pid, se_upper_name)
SELECT als.gnaf_pid, pcl.locality_pid, pcl.old_locality_pid, pcl.locality_name,
