SELECT als.gnaf_pid, als.street_locality_pid, als.locality_pid, als.alias_principal,
  ...
  FROM gnaf_202011.address_aliases as als
  INNER JOIN gnaf_202011.address_alias_lookup as lkp on als.gnaf_pid = lkp.alias_pid
  INNER JOIN gnaf_202011.address_principals as gnaf on lkp.principal_pid = gnaf.gnaf_pid
