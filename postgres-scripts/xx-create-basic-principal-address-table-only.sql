...
DROP TABLE IF EXISTS gnaf_202608.basic_address_principals;
...
SELECT adr.address_detail_pid AS gnaf_pid,
  ...
  FROM raw_gnaf_202608.address_detail AS adr
  INNER JOIN raw_gnaf_202608.address_default_geocode as pnt ON adr.address_detail_pid = pnt.address_detail_pid
  LEFT OUTER JOIN raw_gnaf_202608.geocode_type_aut AS gty ON pnt.geocode_type_code = gty.code
--  LEFT OUTER JOIN (
--  SELECT mb1.address_detail_pid, mb2.mb_2011_code
--    FROM raw_gnaf_202608.address_mesh_block_2011 AS mb1
