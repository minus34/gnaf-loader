...
DROP TABLE IF EXISTS admin_bdys_202108.locality_bdys CASCADE;
CREATE TABLE admin_bdys_202108.locality_bdys(
  gid SERIAL NOT NULL,
...
ALTER TABLE admin_bdys_202108.locality_bdys OWNER TO postgres;

INSERT INTO admin_bdys_202108.locality_bdys (locality_pid, locality_name, state, locality_class, geom)
SELECT loc_pid,
       loc_name,
       state,
       loc_class,
       st_multi(st_union(st_buffer(geom, 0.0))) AS geom
  FROM raw_admin_bdys_202108.aus_localities
...
ANALYZE admin_bdys_202108.locality_bdys;
...
SELECT loc_pid,
       ...
       loc_class,
       st_multi(st_union(st_buffer(geom, 0.0))) AS geom
  FROM raw_admin_bdys_202108.aus_localities AS dat
...
INSERT INTO temp_districts
  ...
  FROM admin_bdys_202108.locality_bdys
  WHERE state = 'ACT';
...
SELECT 'SA250190776' AS locality_pid,
       ...
       --ST_Multi(ST_Buffer((SELECT geom FROM raw_admin_bdys_202108.aus_state_polygon WHERE ST_Intersects(ST_SetSRID(ST_MakePoint(136.1757, -35.0310), 4283), geom)), 0.0)) as geom;
  FROM raw_admin_bdys_202108.aus_state_polygon
...
INSERT INTO admin_bdys_202108.locality_bdys (locality_pid, locality_name, postcode, state, locality_class, geom)
SELECT locality_pid,
       locality_name,
       postcode,
       state,
...
ALTER TABLE admin_bdys_202108.locality_bdys ADD CONSTRAINT locality_bdys_pk PRIMARY KEY (locality_pid);
CREATE UNIQUE INDEX locality_bdys_gid_idx ON admin_bdys_202108.locality_bdys USING btree(gid);
CREATE INDEX locality_bdys_geom_idx ON admin_bdys_202108.locality_bdys USING gist(geom);
ALTER TABLE admin_bdys_202108.locality_bdys CLUSTER ON locality_bdys_geom_idx;
...
DROP TABLE IF EXISTS admin_bdys_202108.postcode_bdys CASCADE;
CREATE UNLOGGED TABLE admin_bdys_202108.postcode_bdys
(
  gid SERIAL NOT NULL,
  postcode text,
  state text NOT NULL,
...
WITH (OIDS=FALSE);
ALTER TABLE admin_bdys_202108.postcode_bdys OWNER TO postgres;
...
DROP TABLE IF EXISTS admin_bdys_202108.state_bdys CASCADE;
CREATE TABLE admin_bdys_202108.state_bdys AS
SELECT bdy.gid,
       tab.state_pid,
       tab.state_name AS name,
       tab.st_abbrev AS state,
       bdy.geom
  FROM raw_admin_bdys_202108.aus_state AS tab
  INNER JOIN raw_admin_bdys_202108.aus_state_polygon AS bdy ON tab.state_pid = bdy.state_pid;

ALTER TABLE admin_bdys_202108.state_bdys ADD CONSTRAINT state_bdys_pk PRIMARY KEY (gid);
CREATE INDEX state_bdys_geom_idx ON admin_bdys_202108.state_bdys USING gist(geom);
ALTER TABLE admin_bdys_202108.state_bdys CLUSTER ON state_bdys_geom_idx;
...
DROP TABLE IF EXISTS admin_bdys_202108.commonwealth_electorates CASCADE;
CREATE TABLE admin_bdys_202108.commonwealth_electorates AS
SELECT bdy.gid,
       tab.ce_pid,
       tab.name,
       tab.dt_gazetd,
       ...
       tab.redistyear,
       bdy.geom
  FROM raw_admin_bdys_202108.aus_comm_electoral AS tab
  INNER JOIN raw_admin_bdys_202108.aus_comm_electoral_polygon AS bdy ON tab.ce_pid = bdy.ce_pid
  INNER JOIN raw_admin_bdys_202108.aus_state AS ste ON tab.state_pid = ste.state_pid;

ALTER TABLE admin_bdys_202108.commonwealth_electorates ADD CONSTRAINT commonwealth_electorates_pk PRIMARY KEY (gid);
CREATE INDEX commonwealth_electorates_geom_idx ON admin_bdys_202108.commonwealth_electorates USING gist(geom);
ALTER TABLE admin_bdys_202108.commonwealth_electorates CLUSTER ON commonwealth_electorates_geom_idx;
...
DROP TABLE IF EXISTS admin_bdys_202108.state_lower_house_electorates CASCADE;
CREATE TABLE admin_bdys_202108.state_lower_house_electorates AS
SELECT bdy.gid,
       ...
       ste.st_abbrev AS state,
       bdy.geom
  FROM raw_admin_bdys_202108.aus_state_electoral AS tab
  INNER JOIN raw_admin_bdys_202108.aus_state_electoral_polygon AS bdy ON tab.se_pid = bdy.se_pid
  INNER JOIN raw_admin_bdys_202108.aus_state AS ste ON tab.state_pid = ste.state_pid
  INNER JOIN raw_admin_bdys_202108.aus_state_electoral_class_aut AS aut ON tab.secl_code = aut.code
  WHERE (tab.eff_end > now() + interval '3 months'
    OR (tab.eff_start <= now() + interval '3 months' AND tab.eff_end IS NULL))
  AND tab.secl_code <> '3';

ALTER TABLE admin_bdys_202108.state_lower_house_electorates ADD CONSTRAINT state_lower_house_electorates_pk PRIMARY KEY (gid);
CREATE INDEX state_lower_house_electorates_geom_idx ON admin_bdys_202108.state_lower_house_electorates USING gist(geom);
ALTER TABLE admin_bdys_202108.state_lower_house_electorates CLUSTER ON state_lower_house_electorates_geom_idx;

-- # --
-- create upper house table
DROP TABLE IF EXISTS admin_bdys_202108.state_upper_house_electorates CASCADE;
CREATE TABLE admin_bdys_202108.state_upper_house_electorates AS
SELECT bdy.gid,
...
ALTER TABLE admin_bdys_202108.state_upper_house_electorates ADD CONSTRAINT state_upper_house_electorates_pk PRIMARY KEY (gid);
CREATE INDEX state_upper_house_electorates_geom_idx ON admin_bdys_202108.state_upper_house_electorates USING gist(geom);
ALTER TABLE admin_bdys_202108.state_upper_house_electorates CLUSTER ON state_upper_house_electorates_geom_idx;
...
ALTER TABLE admin_bdys_202108.local_government_areas CLUSTER ON local_government_areas_geom_idx;
...
ALTER TABLE admin_bdys_202108.local_government_wards CLUSTER ON local_government_wards_geom_idx;
