...
-- gnaf_201911.address_principals
...
DROP TABLE IF EXISTS gnaf_201911.address_principals_reduced;
CREATE TABLE gnaf_201911.address_principals_reduced AS
WITH adr AS (
...
ANALYSE gnaf_201911.address_principals_reduced;
...
CREATE INDEX basic_address_principals_reduced_geom_idx ON gnaf_201911.address_principals_reduced USING gist (geom);
ALTER TABLE gnaf_201911.address_principals_reduced CLUSTER ON basic_address_principals_reduced_geom_idx;

CREATE INDEX basic_address_principals_reduced_mb_2016_code_idx ON gnaf_201911.address_principals_reduced USING btree(mb_2016_code);
