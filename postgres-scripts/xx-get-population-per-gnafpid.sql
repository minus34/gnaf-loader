...
--ANALYSE testing.mb_2026_counts;
--
--CREATE INDEX mb_2026_counts_geom_idx ON testing.mb_2026_counts USING gist(geom);
--ALTER TABLE testing.mb_2026_counts CLUSTER ON mb_2026_counts_geom_idx;
...
select sum(dwelling) from testing.mb_2026_counts where geom is not null; -- 9,913,151
select sum(dwelling) from testing.mb_2026_counts where geom is null; -- 286
...
select sum(person) from testing.mb_2026_counts where geom is not null; -- 23351637
select sum(person) from testing.mb_2026_counts where geom is null; -- 46354
...
-- SELECT count(*) FROM testing.mb_2026_counts
-- WHERE address_count > dwelling;
