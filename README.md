...
- `--geoscape-version` Geoscape version number in YYYYMM format. Defaults to current year and last release month. e.g. `202608`.
- `--previous-geoscape-version` Previous Geoscape release version number as YYYYMM; used for QA comparison. e.g. `202605`.
...
- Local Postgres server: `python load-gnaf.py --gnaf-tables-path="C:\temp\geoscape_202608\G-NAF" --admin-bdys-path="C:\temp\geoscape_202608\Administrative Boundaries"` Loads the GNAF tables to a Postgres server running locally. GNAF archives have been extracted to the folder `C:\temp\geoscape_202608\G-NAF`, and admin boundaries have been extracted to the `C:\temp\geoscape_202608\Administrative Boundaries` folder.
...
1. Download the [GNAF dump file](https://minus34.com/opendata/geoscape-202608/gnaf-202608.dmp) or [GNAF GDA2020 dump file](https://minus34.com/opendata/geoscape-202608-gda2020/gnaf-202608.dmp) (~2.0Gb)
2. Download the [Admin Bdys dump file](https://minus34.com/opendata/geoscape-202608/admin-bdys-202608.dmp) or [Admin Bdys GDA2020 dump file](https://minus34.com/opendata/geoscape-202608-gda2020/admin-bdys-202608.dmp) (~2.8Gb)
...
The files are here: `s3://minus34.com/opendata/geoscape-202608/geoparquet/`

### AWS CLI Examples

- List all datasets: `aws s3 ls s3://minus34.com/opendata/geoscape-202608/geoparquet/`
- Copy all datasets: `aws s3 sync s3://minus34.com/opendata/geoscape-202608/geoparquet/ <my-local-folder>`
