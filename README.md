...
* `--previous-geoscape-version` Previous Geoscape release version number as YYYYMM; used for QA comparison. e.g. `202305`.
...
* Local Postgres server: `python load-gnaf.py --gnaf-tables-path="C:\temp\geoscape_202308\G-NAF" --admin-bdys-path="C:\temp\geoscape_202308\Administrative Boundaries"` Loads the GNAF tables to a Postgres server running locally. GNAF archives have been extracted to the folder `C:\temp\geoscape_202308\G-NAF`, and admin boundaries have been extracted to the `C:\temp\geoscape_202308\Administrative Boundaries` folder.
...
### Process
1. Download the [GNAF dump file](https://minus34.com/opendata/geoscape-202308/gnaf-202308.dmp) or [GNAF GDA2020 dump file](https://minus34.com/opendata/geoscape-202308-gda2020/gnaf-202308.dmp) (~2.0Gb)
2. Download the [Admin Bdys dump file](https://minus34.com/opendata/geoscape-202308/admin-bdys-202308.dmp) or [Admin Bdys GDA2020 dump file](https://minus34.com/opendata/geoscape-202308-gda2020/admin-bdys-202308.dmp) (~2.8Gb)
...
- Copy all datasets: `aws s3 sync s3://minus34.com/opendata/geoscape-202308/parquet/ <my-local-folder>`
