...
echo "y" | conda install -c conda-forge pyspark=${SPARK_VERSION} pyspark-stubs psycopg2 dask geopandas pygeos geoalchemy2 jupyter lux-api pyarrow matplotlib scipy bs4 requests boto3
