--DROP TABLE IF EXISTS gnaf_202608.temp_address_principals;
--CREATE TABLE gnaf_202608.temp_address_principals AS
...
--FROM gnaf_202608.address_principals;
--
--ALTER TABLE ONLY gnaf_202608.temp_address_principals
