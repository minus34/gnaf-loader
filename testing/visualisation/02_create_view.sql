--DROP TABLE IF EXISTS gnaf_202202.temp_address_principals;
--CREATE TABLE gnaf_202202.temp_address_principals AS
...
--FROM gnaf_202202.address_principals;
--
--ALTER TABLE ONLY gnaf_202202.temp_address_principals
