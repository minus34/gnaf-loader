--DROP TABLE IF EXISTS gnaf_202311.temp_address_principals;
--CREATE TABLE gnaf_202311.temp_address_principals AS
...
--FROM gnaf_202311.address_principals;
--
--ALTER TABLE ONLY gnaf_202311.temp_address_principals
