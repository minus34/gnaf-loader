--DROP TABLE IF EXISTS gnaf_202402.temp_address_principals;
--CREATE TABLE gnaf_202402.temp_address_principals AS
...
--FROM gnaf_202402.address_principals;
--
--ALTER TABLE ONLY gnaf_202402.temp_address_principals
