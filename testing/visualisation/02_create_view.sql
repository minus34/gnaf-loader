--DROP TABLE IF EXISTS gnaf_202302.temp_address_principals;
--CREATE TABLE gnaf_202302.temp_address_principals AS
...
--FROM gnaf_202302.address_principals;
--
--ALTER TABLE ONLY gnaf_202302.temp_address_principals
