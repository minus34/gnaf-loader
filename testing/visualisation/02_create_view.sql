--DROP TABLE IF EXISTS gnaf_202605.temp_address_principals;
--CREATE TABLE gnaf_202605.temp_address_principals AS
...
--FROM gnaf_202605.address_principals;
--
--ALTER TABLE ONLY gnaf_202605.temp_address_principals
