--DROP TABLE IF EXISTS gnaf_202405.temp_address_principals;
--CREATE TABLE gnaf_202405.temp_address_principals AS
...
--FROM gnaf_202405.address_principals;
--
--ALTER TABLE ONLY gnaf_202405.temp_address_principals
