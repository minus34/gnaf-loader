...
INSTALL_DIR="/Users/$(whoami)/gdal-3.5.0"
...
#curl -O -L --insecure https://github.com/OSGeo/gdal/releases/download/v3.5.0/gdal-3.5.0.tar.gz
...
#-DCMAKE_PREFIX_PATH:FILEPATH="/usr/local/Cellar" \
