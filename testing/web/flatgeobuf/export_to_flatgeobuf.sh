...
# full addresses
ogr2ogr -f FlatGeobuf ${output_folder}/address-principals-202208.fgb \
PG:"host=localhost dbname=geo user=postgres password=password port=5432" "gnaf_202208.address_principals(geom)"
...
ogr2ogr -f FlatGeobuf ${output_folder}/address-principals-202208.fgb \
PG:"host=localhost dbname=geo user=postgres password=password port=5432" "admin_bdys_202208.locality_bdys_display(geom)"
...
for f in *-202208.fgb;
  do
    aws --profile=default s3 cp --storage-class REDUCED_REDUNDANCY ./${f} s3://minus34.com/opendata/geoscape-202208/flatgeobuf/${f};
    aws --profile=default s3api put-object-acl --acl public-read --bucket minus34.com --key opendata/geoscape-202208/flatgeobuf/${f}
